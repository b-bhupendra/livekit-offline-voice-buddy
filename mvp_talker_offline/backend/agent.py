...
async def entrypoint(ctx: agents.JobContext):
    ...
    async def on_user_input(ev):
        ...
        if transcript:
            if is_final:
                print(f"\n[Transcribed Input] (final=True): \"{transcript}\"")
    ...
    async def rpc_submit_quiz_answer(data: rtc.RpcInvocationData) -> str:
        try:
            ...
            try:
                ...
                print(f"[LiveKit] Failed to broadcast progress after answer: {e}")
    ...
    async def push_periodic_progress():
        ...
        while True:
            try:
                ...
                print(f"[Periodic Progress] notice: {e}")
    ...
    try:
        ...
        print(f"[LiveKit] Initial progress broadcast notice: {e}")
