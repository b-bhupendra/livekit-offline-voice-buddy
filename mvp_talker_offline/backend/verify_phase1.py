...
class TestPhase1Backend(unittest.TestCase):
    def setUp(self):
        ...
        self.tracker = syllabus_tracker.SyllabusTracker(user_id="test_suite_user")
    ...
    def test_04_anti_hallucination_dispute_and_web_search(self):
        ...
        # MCP tool check
        mcp_summary = memory_mcp_server.get_learner_summary()
        self.assertIn("Learner Profile", mcp_summary)
