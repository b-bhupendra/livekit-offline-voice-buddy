...
class SyllabusTracker:
    ...
    def get_dynamic_course_session(
        ...
        # Dynamic Synthesis based on submodule & session_type
        if "concrete" in submodule.lower() or "abstract" in submodule.lower():
            spoken = "Concrete nouns are physical objects you can touch or see, like books and rain, while abstract nouns are ideas and feelings, like courage and patience. Remember, you cannot touch courage, but you experience it."
            paras = [
                f"Concrete nouns designate tangible entities existing in physical space that can be directly observed through at least one of your five senses: sight, touch, sound, smell, or taste. Everyday instances include items like 'laptop', 'coffee', 'desk', and 'thunder'{citation_str}. Because these items possess physical boundaries, they can be measured, photographed, and easily grouped into units.",
