...
from langgraph_tutor_graph import langgraph_engine, TutorState
...
class TestLangGraphLiveKitSystem(unittest.TestCase):
    ...
    def test_03_dynamic_session_synthesis(self):
        ...
        self.assertEqual(nouns_sess["canvas_type"], "particle_classifier")
        ...
        self.assertEqual(rep_sess["canvas_type"], "repetition_flow")
        ...
        self.assertEqual(work_sess["canvas_type"], "workplace_matrix")
        self.assertIn("pairs", work_sess["canvas_config"])
