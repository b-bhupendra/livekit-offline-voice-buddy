...
BE_CHUNKS = {
    "01_BE_CORE_PIPELINE.txt": [
        ...
        ("mcp/mcp_registry.json", "Authoritative registry of all 10 MCP servers (Design, Docs, System) configured for Buddy Voice AI", "json"),
        ("mcp/inspect_mcp.py", "Modular CLI inspector providing terminal dashboard of MCP servers, categories, and 95 tools", "python"),
        ("mcp/README.md", "Complete architectural documentation for the modularized MCP codespace", "markdown"),
    ...
    "03_BE_LANGGRAPH_AND_TUTOR.txt": [
        ("mvp_talker_offline/backend/tutor/curriculum_crawler.py", "Autonomous ChromaDB Content Crawler and dynamic coursework synthesizer replacing static dictionaries with on-demand RAG authoring and universal HTML5 canvas generation", "python"),
